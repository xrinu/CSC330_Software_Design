...
public class RadioController {
	 ...
	 */
	protected void executeScript() throws RadioException  {
	...
	protected void executeCommand(String [] commandArgs) throws RadioException {
		...
		switch (command)  {
			...
			default:
					throw new RadioException("unrecognized command: ", RadioException.INVALID_OPERATION);  
		}
